          ...
          <div className="flex flex-col md:px-5 relative w-full">
            <div className="flex flex-col mx-auto w-full">
                  ...
                  <div className="bg-white-A700 flex flex-col items-center justify-start mt-[9px] p-[57px] md:px-10 sm:px-5 rounded-[5px] w-[99%] md:w-full">
                    <div className="flex md:flex-col flex-row gap-10 items-center justify-start mb-[41px] py-14 w-[95%] md:w-full">
                      <div className="flex flex-col items-start justify-start md:mt-0 mt-2 py-[72px] w-[38%] md:w-full">
                        <div className="flex flex-col items-center justify-start">
                          <Text
                            className="md:text-5xl text-6xl text-gray-900_10 tracking-[-1.50px]"
                        ...
                        <div className="bg-orange-600 flex flex-row gap-[54px] items-center justify-start mb-2 mt-10 p-[15px] rounded-[36px] shadow-bs17 w-[84%] md:w-full">
                          <Text
                          ...
                          <div className="flex flex-col h-[42px] items-center justify-start w-[42px]">
                            <Button
                              className="flex h-[42px] items-center justify-center shadow-bs18 w-[42px]"
                              shape="circle"
                              color="white_A700"
                              size="md"
                              variant="fill"
              ...
              <div className="flex flex-col gap-11 items-center justify-end ml-[109px] mt-[-287px] p-20 md:px-10 sm:px-5 w-4/5 z-[1]">
                <div className="flex flex-col items-center justify-start mt-[15px] px-[19px]">
                  <Text
                    className="text-3xl sm:text-[26px] md:text-[28px] text-center text-gray-900_10 tracking-[-0.75px]"
                    size="txtSegoeUI30"
                  >
            ...
            <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mt-[-55px] mx-auto py-10 w-4/5 z-[1]">
              <div className="flex flex-col gap-[37px] items-start justify-start md:mt-0 mt-10 pb-[260px] w-[28%] md:w-full">
                <div className="bg-white-A700 flex flex-col h-20 items-center justify-start p-6 sm:px-5 rounded-[50%] shadow-bs19 w-20">
                  <Img
                    className="h-8 w-8"
                ...
                <div className="flex flex-col items-start justify-start w-full">
                  <Text
                    className="leading-[40.00px] text-4xl sm:text-[32px] md:text-[34px] text-gray-900_10 tracking-[-0.90px]"
                    size="txtSegoeUI36"
                  >
                    <>
                      Frequently Asked
              ...
              >
                <div className="border-gray-300_05 border-solid border-t flex flex-col items-center justify-end p-4 w-full">
                  <div className="flex flex-row sm:gap-10 items-center justify-between p-[7px] w-full">
                    <Text
                      className="ml-2 text-gray-900_10 text-xl"
                      size="txtSegoeUI20"
                    >
                ...
                <div className="border-gray-300_05 border-solid border-t flex flex-col items-center justify-end p-4 w-full">
                  <div className="flex sm:flex-col flex-row sm:gap-[49px] items-center justify-between p-[7px] w-full">
                    <Text
                      className="ml-2 sm:ml-[0] text-gray-900_10 text-xl"
                      size="txtSegoeUI20"
                    >
                ...
                <div className="border-gray-300_05 border-solid border-t flex flex-col items-center justify-end p-4 w-full">
                  <div className="flex flex-row sm:gap-10 items-center justify-between p-[7px] w-full">
                    <Text
                      className="ml-2 mt-0.5 text-gray-900_10 text-xl"
                      size="txtSegoeUI20"
                    >
                ...
                <div className="border-gray-300_05 border-solid border-y flex flex-col items-center justify-start p-4 w-full">
                  <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between p-[5px] w-full">
                    <Text
                      className="ml-2.5 sm:ml-[0] sm:mt-0 mt-[5px] text-gray-900_10 text-xl"
                      size="txtSegoeUI20"
                    >
