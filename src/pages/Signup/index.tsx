                    ...
                    <div className="flex flex-col items-center justify-start md:px-10 sm:px-5 px-[161px] w-full">
                      <div className="h-[734px] md:h-[859px] relative w-[97%] md:w-full">
                        ...
                        <div className="absolute flex flex-col md:gap-10 gap-[60px] h-max inset-y-[0] justify-start my-auto right-[0] w-[94%]">
                          ...
                          <div className="flex flex-col items-center justify-start w-full">
                            <div className="md:gap-5 grid md:grid-cols-1 grid-cols-2 min-h-[auto] w-[91%]">
                              <div className="h-[52px] pl-[11px] relative w-full">
                                <div className="absolute border-b-2 border-solid border-white-A700_7f h-[52px] inset-[0] justify-center m-auto w-[93%]"></div>
                                <div className="absolute flex flex-col inset-x-[0] items-start justify-start mx-auto top-[27%]">
                                  <Text
                              ...
                              <div className="h-[52px] pl-[11px] relative w-full">
                                <div className="absolute border-b-2 border-solid border-white-A700_7f h-[52px] inset-[0] justify-center m-auto w-[93%]"></div>
                                <div className="absolute flex flex-col inset-x-[0] items-start justify-start mx-auto top-[29%]">
                                  <Text
                                    className="text-[15px] text-pink-50"
                                    size="txtMontserratRegular15"
                                  >
