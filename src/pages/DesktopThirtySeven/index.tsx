                    ...
                    <div className="flex flex-col items-center justify-start mb-[15px] w-full">
                      ...
                      <div className="flex flex-row items-center justify-evenly mt-[3px] py-[11px] w-full">
                        ...
                        <div className="flex relative w-[84%]">
                          ...
                          <Img
                            className="h-2.5 mb-1 ml-[-0.31px] mt-auto z-[1]"
                  ...
                  <div className="h-10 md:h-[55px] mb-[15px] md:ml-[0] ml-[30px] md:pr-10 sm:pr-5 pr-[471px] relative shadow-bs8 w-3/5 md:w-full">
                    <div className="flex flex-col h-full items-center justify-start my-auto w-[18%]">
                      <div className="bg-white-A700 border border-gray-300 border-solid h-10 pr-[5px] relative w-full">
                        <Text
                          className="absolute bottom-1/4 right-[9%] text-[15px] text-center text-gray-800_12"
                          size="txtRobotoRegular15Gray80012"
                        >
                          Edit profile
                        </Text>
            ...
            <div className="flex flex-col justify-start w-full">
              ...
              <div className="flex flex-col items-center justify-start ml-2.5 md:ml-[0] w-[41%] md:w-full">
                ...
                <div className="flex flex-col items-start justify-start mt-[3px] w-full">
                  ...
                  <Text
                    className="bg-white-A700 border-gray-300 border-l-4 border-r border-solid border-y h-9 justify-center mt-[5px] pl-5 sm:pr-5 pr-[35px] py-2.5 text-black-900 text-shadow-ts1 text-xs w-[425px]"
                    size="txtRobotoRegular12Black900"
                  >
              ...
              <div className="flex flex-col items-center justify-start ml-2.5 md:ml-[0] mt-5 pb-[3px] w-[82%] md:w-full">
                ...
                <Input
                  ...
                  className="!placeholder:text-gray-600_06 !text-gray-600_06 leading-[normal] p-0 text-[15px] text-left w-full"
                ...
                <div className="flex sm:flex-col flex-row sm:gap-5 items-center justify-start mt-[3px] pr-[5px] py-[5px] w-full">
                  ...
                  <div className="flex sm:flex-1 flex-col items-start justify-start ml-0.5 sm:ml-[0] pb-0.5 pr-0.5 w-[15%] sm:w-full">
                    <Radio
                      value="Male"
                      className="leading-[normal] text-black-900 text-left text-xs"
                      inputClassName="bg-white-A700 border border-gray-600_05 border-solid h-[13px] mr-[5px] rounded-md w-[13px]"
                      checked={false}
                      name="male"
                      label=" Male"
                      id="Male"
              ...
              <div className="h-28 ml-2.5 md:ml-[0] relative w-[41%] sm:w-full">
                <div className="absolute bg-gradient1  border border-red-900_05 border-solid flex flex-col inset-x-[0] items-start justify-start mx-auto p-2.5 top-[21%] w-full">
                  <Text
              ...
              >
                <div className="flex flex-row items-start justify-evenly w-full">
                  <div className="bg-white-A700 border border-gray-600_05 border-solid h-[13px] mb-[9px] mt-[3px] rounded-sm w-[13px]"></div>
                  <Text
                    className="bg-deep_purple-400_01 border-[3px] border-gray-300_09 border-solid flex h-[26px] items-center justify-center rounded-[50%] text-center text-white-A700 text-xs w-[26px]"
                    size="txtInterRegular12WhiteA700_1"
                  >
                    H
                  </Text>
                </div>
                <div className="flex flex-row items-start justify-center w-full">
                  <div className="bg-white-A700 border border-gray-600_05 border-solid h-[13px] mb-[9px] mt-[3px] rounded-sm w-[13px]"></div>
                  <Text
                    className="bg-green-600 border-[3px] border-light_green-100_01 border-solid flex h-[26px] items-center justify-center ml-[5px] rounded-[50%] text-center text-white-A700 text-xs w-[26px]"
                    size="txtInterRegular12WhiteA700_1"
                  >
                    G
                  </Text>
                ...
                <div className="flex flex-row items-start justify-center w-full">
                  <div className="bg-white-A700 border border-gray-600_05 border-solid h-[13px] mb-[9px] mt-[3px] rounded-sm w-[13px]"></div>
                  <Text
                    className="bg-light_green-600_02 border-[3px] border-light_green-100_02 border-solid flex h-[26px] items-center justify-center ml-[5px] rounded-[50%] text-center text-white-A700 text-xs w-[26px]"
                    size="txtInterRegular12WhiteA700_1"
                  >
                    P
                  </Text>
                ...
                <div className="flex flex-row items-start justify-center w-full">
                  <div className="bg-white-A700 border border-gray-600_05 border-solid h-[13px] mb-[9px] mt-[3px] rounded-sm w-[13px]"></div>
                  <Text
                    className="bg-green-A700_01 border-[3px] border-green-A100 border-solid flex h-[26px] items-center justify-center ml-[5px] rounded-[50%] text-center text-white-A700 text-xs w-[26px]"
                    size="txtInterRegular12WhiteA700_1"
                  >
                    Q
                  </Text>
                ...
                <div className="flex flex-row items-start justify-center w-full">
                  <div className="bg-white-A700 border border-gray-600_05 border-solid h-[13px] mb-[9px] mt-[3px] rounded-sm w-[13px]"></div>
                  <Text
                    className="bg-blue-A700_01 border-[3px] border-indigo-100_01 border-solid flex h-[26px] items-center justify-center ml-[5px] rounded-[50%] text-base text-center text-white-A700 w-[26px]"
