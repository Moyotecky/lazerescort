    ...
    <>
      <div className="bg-white-A700 flex flex-col font-montserrat gap-[42px] items-center justify-end mx-auto w-full">
        ...
        <div className="h-[1062px] md:h-[897px] md:px-5 relative w-full">
                  ...
                  <div className="flex flex-col items-center justify-start py-6 w-full">
                    <div className="flex flex-col items-center justify-start md:px-10 sm:px-5 px-[185px] w-full">
                      <div className="bg-gradient11  h-[731px] sm:h-[741px] relative rounded-md w-full">
                        <div className="h-[731px] sm:h-[741px] m-auto w-full">
                          ...
                          <div className="absolute flex flex-col h-max inset-[0] items-start justify-center m-auto w-[89%]">
                            ...
                            <div className="flex sm:flex-col flex-row font-inter gap-[26px] items-start justify-between md:ml-[0] ml-[11px] mt-[50px] p-2.5 w-[99%] md:w-full">
                              <Button
                                className="cursor-pointer flex items-center justify-center mb-[66px] min-w-[297px] sm:ml-[0] ml-[5px] rounded-[5px]"
                                leftIcon={
                                  <Img
                              ...
                              <Button
                                className="cursor-pointer flex items-center justify-center mb-[66px] min-w-[297px] mr-[7px] rounded-[5px]"
                                leftIcon={
                                  <Img
                        ...
                        <div className="absolute flex flex-col font-roboto md:gap-10 gap-[608px] h-max inset-y-[0] justify-start my-auto right-[3%] w-[72%]">
                          <div className="flex flex-row gap-[22px] items-start justify-end md:ml-[0] ml-[411px] w-[24%] md:w-full">
                          ...
                          <div className="flex flex-col font-inter h-12 md:h-auto items-start justify-start mr-[115px] w-[420px] sm:w-full">
                            <div className="bg-gray-100 border border-gray-100 border-solid flex flex-col h-12 md:h-auto items-start justify-start px-[17px] py-3.5 rounded-lg w-full">
                              <div
          ...
          <div className="absolute flex flex-col inset-x-[0] items-start justify-end mx-auto top-[1%] w-full">
            <div className="bg-gray-200_01 flex flex-col items-center justify-start md:ml-[0] ml-[564px] p-1 w-[17%] md:w-full">
