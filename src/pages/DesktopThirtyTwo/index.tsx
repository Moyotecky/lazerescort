        ...
        <div className="flex flex-col items-end md:px-10 sm:px-5 px-[165px] w-full">
          <header className="flex md:flex-col flex-row md:gap-5 items-center justify-center w-full">
            <Img
              ...
              alt="divsection"
            />
            <div className="flex md:flex-1 flex-col items-center justify-start md:ml-[0] ml-[107px] md:mt-0 my-1.5 w-[67%] md:w-full">
              <div className="flex md:flex-col flex-row md:gap-5 items-center justify-evenly py-2.5 w-full">
                <div className="flex md:flex-1 md:flex-col flex-row md:gap-5 items-center justify-start w-[97%] md:w-full">
                  <div className="flex flex-col items-start justify-start w-[11%] md:w-full">
                    <div className="flex flex-col items-center justify-start py-[3px] w-[78%] md:w-full">
                  ...
                  <div className="flex flex-col items-start justify-start w-[12%] md:w-full">
                    <div className="flex flex-col items-center justify-start py-[3px] w-4/5 md:w-full">
                      <div className="flex flex-col items-center justify-start w-full">
                        <div className="flex flex-col items-center justify-start w-full">
                          <Text
                  ...
                  <List
                    className="sm:flex-col flex-row gap-px grid grid-cols-2 w-[21%] md:w-full"
                    orientation="horizontal"
                  >
                    <div className="flex flex-col items-start justify-start sm:ml-[0] w-full">
                      <div className="flex flex-col items-center justify-start py-[3px] w-[84%] md:w-full">
                        <div className="flex flex-col items-center justify-start w-full">
                          <div className="flex flex-col items-center justify-start w-full">
                            <Text
                              className="text-black-900 text-sm tracking-[0.30px]"
                    ...
                    <div className="flex flex-col h-10 items-start justify-start sm:ml-[0] w-full">
                      <div className="flex flex-col items-center justify-start py-[3px] w-[65%] md:w-full">
                        <div className="flex flex-col items-center justify-start w-full">
                          <div className="flex flex-col items-center justify-start w-full">
                            <Text
                              className="text-black-900 text-sm tracking-[0.30px]"
                  ...
                  <List
                    className="sm:flex-col flex-row grid grid-cols-2 w-[32%] md:w-full"
                    orientation="horizontal"
                  >
                    <div className="flex flex-col items-start justify-start w-full">
                      <div className="flex flex-col items-center justify-start py-[3px] w-[86%] md:w-full">
                        <div className="flex flex-col items-center justify-start w-full">
                          <div className="flex flex-col items-center justify-start w-full">
                            <Text
                              className="text-black-900 text-sm tracking-[0.30px]"
                    ...
                    <div className="flex flex-col items-start justify-start w-full">
                      <div className="flex flex-col items-center justify-start py-[3px] w-[85%] md:w-full">
                        <div className="flex flex-col items-center justify-start w-full">
                          <div className="flex flex-col items-center justify-start w-full">
                            <Text
                              className="text-black-900 text-sm tracking-[0.30px]"
                  ...
                  <div className="flex flex-col items-start justify-start w-[26%] md:w-full">
                    <div className="flex flex-col items-center justify-start w-[91%] md:w-full">
                      <Button
                        className="cursor-pointer min-w-[144px] text-center text-sm tracking-[0.30px]"
                        shape="square"
                        color="orange_600"
                        size="lg"
                        variant="outline"
                ...
                <Img className="h-10" src="images/img_close.svg" alt="close" />
              </div>
            </div>
          </header>
        </div>
        <div className="flex flex-col font-montserrat md:gap-10 gap-[177px] items-center mb-[214px] w-full">
          <div className="md:h-[1695px] sm:h-[3363px] h-[3728px] md:px-5 relative w-full">
            <div className="flex flex-col md:gap-10 gap-[483px] h-full items-center justify-start m-auto w-full">
              <div className="md:h-[1309px] sm:h-[2534px] h-[2897px] relative w-full">
                <div className="md:h-[1309px] sm:h-[2534px] h-[2897px] m-auto w-full">
                  <div className="absolute md:h-[1277px] h-[2299px] sm:h-[2534px] inset-x-[0] mx-auto top-[0] w-full">
                    <div className="md:h-[1277px] h-[2299px] sm:h-[2534px] m-auto w-full">
                      <div className="absolute md:h-[1277px] h-[1279px] sm:h-[2534px] inset-x-[0] mx-auto top-[0] w-[97%] md:w-full">
                        <div
                          ...
                          style={{
                            backgroundImage: "url('images/img_group141.png')",
                          }}
                        >
                        ...
                        <div className="absolute flex flex-col md:gap-10 gap-[120px] h-max inset-y-[0] items-end justify-start left-[0] my-auto w-2/5">
                          ...
                          <div className="bg-gradient8  flex flex-col gap-[29px] items-center justify-center p-5 w-full">
                            <List
                              className="flex flex-col gap-5 items-center mt-[39px] w-full"
                              orientation="vertical"
                            >
                              <div className="flex flex-1 flex-col items-center justify-start w-full">
                                <div className="flex flex-col items-center justify-start pb-[29px] sm:px-5 px-[29px] w-full">
                                  <div className="h-[62px] px-[11px] relative w-full">
                                    <Text
                                      className="mb-[-8.29px] text-[15px] text-pink-50 z-[1]"
                                      size="txtMontserratRegular15"
                                    >
                                      I am a:
                                    </Text>
                                    <div className="md:h-[51px] h-[52px] mt-auto mx-auto w-[96%] sm:w-full">
                                      <Img
                                ...
                                <div className="flex flex-col items-center justify-start pb-[30px] sm:px-5 px-[30px] w-full">
                                  <div className="h-[61px] px-[11px] relative w-full">
                                    <Text
                                      className="mb-[-9.38px] text-[15px] text-pink-50 z-[1]"
                                      size="txtMontserratRegular15"
                                    >
                                      <>I&#39;m looking for a:</>
                                    </Text>
                              ...
                              <div className="flex flex-1 flex-col items-center justify-start w-full">
                                <div className="flex flex-col items-center justify-start pb-[30px] sm:px-5 px-[30px] w-full">
                                  <div className="md:h-[51px] h-[61px] px-[11px] relative w-full">
                                    <div className="absolute bottom-[0] md:h-[51px] h-[52px] inset-x-[0] mx-auto w-[96%] sm:w-full">
                                      <Img
                                        className="absolute h-6 inset-y-[0] my-auto right-[0] w-6"
                                        src="images/img_svg.svg"
                                        alt="svg"
                                      ...
                                      <div className="absolute border-b-2 border-solid border-white-A700_7f flex flex-col h-full inset-[0] items-center justify-center m-auto py-4 w-full">
                                        <div className="flex flex-col items-start justify-start mb-0.5 w-full">
                                          <Text
                                            className="h-[17px] text-sm text-white-A700"
                                            size="txtMontserratMedium14"
                                          >
                                            20
                                          </Text>
                                ...
                                <div className="flex flex-col items-center justify-start pb-7 sm:px-5 px-7 w-full">
                    ...
                    <div className="absolute bottom-[19%] flex flex-col items-center justify-start left-[0] w-[91%]">
                  ...
                  <div className="absolute bottom-[0] sm:h-[1295px] md:h-[1309px] h-[1325px] inset-x-[0] mx-auto w-[99%] md:w-full">
              ...
              <div className="flex flex-col items-center justify-start p-[5px] w-[61%] md:w-full">
            ...
            <div className="absolute bottom-[8%] flex flex-col font-librefranklin inset-x-[0] items-center justify-start mx-auto w-[63%]">
              <div className="flex flex-col md:gap-10 gap-[117px] items-center justify-start py-[117px] w-full">
                <div className="flex flex-col items-center justify-start md:px-10 sm:px-5 px-[299px] w-full">
                  <Text
                  ...
                  <div className="flex flex-1 flex-col items-center justify-start px-[11px] w-full">
                    <div className="flex flex-col items-center justify-start w-full">
                      <Img
                        ...
                        alt="favorite"
                      />
                      <div className="md:h-24 h-[73px] mt-[23px] md:px-10 sm:px-5 px-[65px] relative w-full">
                        <Text
                          className="absolute h-max inset-[0] justify-center m-auto text-black-900_dd text-center text-xl w-max"
                  ...
                  <div className="flex flex-1 flex-col items-center justify-start px-[11px] w-full">
                    <div className="flex flex-col items-center justify-start w-full">
                      <Img
                        ...
                        alt="floatingicon"
                      />
                      <div className="h-[73px] md:h-[95px] mt-[22px] md:px-10 sm:px-5 px-[74px] relative w-full">
                        <Text
                          className="absolute h-max inset-[0] justify-center m-auto text-black-900_dd text-center text-xl w-max"
                          size="txtLibreFranklinMedium20"
                        >
                  ...
                  <div className="flex flex-1 flex-col items-center justify-start px-[11px] w-full">
                    <div className="flex flex-col items-center justify-start w-full">
                      <Img
                        ...
                        alt="close"
                      />
                      <div className="md:h-24 h-[73px] mt-[23px] md:px-10 sm:px-5 px-[81px] relative w-full">
                        <Text
                          className="absolute bottom-[29%] inset-x-[0] mx-auto text-black-900_dd text-center text-xl w-max"
                          size="txtLibreFranklinMedium20"
                        >
                          Start Dating
                        </Text>
